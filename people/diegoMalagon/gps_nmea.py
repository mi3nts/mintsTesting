...
class GPS_NMEA:
    def __init__(self, baudrate, timeout, port='/dev/ttyACM2'):
        ...
        for sentence in sentences:
            ...
            try:
                match parts[0]:
                    ...
                    latitudeDegrees = str(int(latitudeUnprocessed / 100)) + "°"
                    ...
                    longitudeDegrees = str(int(longitudeUnprocessed / 100)) + "°"
                    ...
                    result['$GPVTG'] = OrderedDict([
                        ('true track', f'{parts[1]}° T'),
                        ('magnetic track', f'{parts[3]}° M'),
